...
\begin{align}
\vec{A}=\myvec{1\\-1},\vec{B}=\myvec{-4\\6}\\\vec{C}=\myvec{-3\\-5},\vec{D}=\myvec{-3.5\\0.5}\\\vec{E}=\myvec{-1\\-3},\vec{F}=\myvec{-1.5\\2.5}\\\vec{G}=\myvec{-2\\0}
\end{align}We have to find $AG$ and $GD$.
\begin{align}
AG &= \norm{\vec{G} - \vec{A}} \\
