...
Solution: Three vertices of the triangle are:
\begin{align}
    \vec{A} &= \myvec{1 \\-1} \\
    \vec{B} &= \myvec{-4 \\ 6} \\
    \vec{C} &= \myvec{-3 \\-5}
\end{align}If $\vec{D}$ divides $\vec{BC}$ in the ratio $k:1$ 
\begin{align}
    \vec{D} &= \frac{k\vec{C} + \vec{B}}{k+1}
\end{align}
Since $D$ is midpoint of $BC$,
\begin{align}
    \vec{D} &= \frac{\vec{C} + \vec{B}}{2} \\
    \vec{D} &= \frac{\myvec{-3 \\ -5}+\myvec{-4 \\ 6}}{2} \\
    \vec{D} &= \myvec{-3.5 \\ 0.5}
\end{align}\\
Since $E$ is midpoint of $CA$,
\begin{align}
    \vec{E} &= \frac{\vec{A} + \vec{C}}{2} \\
    \vec{E} &= \frac{\myvec{1 \\ -1}+ \myvec{-3 \\ -5}}{2} \\
    \vec{E} &= \myvec{-1 \\-3}
\end{align}\\
Since $F$ is midpoint of $AB$,
\begin{align}
    \vec{F} &= \frac{\vec{B} + \vec{A}}{2} \\
    \vec{F} &= \frac{\myvec{-4 \\ 6}+\myvec{1 \\ -1}}{2} \\
    \vec{F} &= \myvec{-1.5 \\ 2.5}
\end{align}
\\For equation of $AD$ we have point $A$ and direction vector $\vec{AD}$.
\begin{align}
    \vec{A} &= \myvec{1 & -1}    
\end{align}
...
0 & -8 & 0
\end{bmatrix}
\xrightarrow{R_{2}\,\xrightarrow{}\,R_{2}/8}
\begin{bmatrix}
1 & 3 & -2 \\
0 & 1 & 0
\end{bmatrix}
...
0 & 1 & 0
\end{bmatrix}
\xrightarrow{R_{1}\,\xrightarrow{}\,R_{1}-3R_{2}}
\begin{bmatrix}
1 & 0 & -2 \\
0 & 1 & 0
\end{bmatrix}
\end{align} 
The centroid $G$ is $\vec{G}$ = $\myvec{-2 \\ 0}$\\\\
We have to find $AG$ and $GD$.\\
\\$\norm{\vec{AG}}$ = $\norm{\vec{G} -\vec{A}}$ \\\\= $\norm{\,\myvec{-2 \\ 0}-\myvec{1 \\ -1}\,}$ = $\norm{\,\myvec{-3 \\ 1}\,}$ = $\sqrt{10}$\\\\
\\$\norm{\vec{GD}}$ = $\norm{\vec{D} -\vec{G}}$ \\\\= $\norm{\,\myvec{-3.5 \\ -0.5}-\myvec{-2 \\ 0}\,}$ = $\norm{\,\myvec{-1.5 \\ -0.5}\,}$ = $\sqrt{2.5}$\\\\
The ratio $AG:GD$ is $\frac{\sqrt{10}}{\sqrt{2.5}}$ = 2:1\\\\
We have to find $BG$ and $GE$.\\
